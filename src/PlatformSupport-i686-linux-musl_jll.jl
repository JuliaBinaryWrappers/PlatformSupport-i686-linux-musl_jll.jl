module PlatformSupport-i686-linux-musl_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PlatformSupport-i686-linux-musl_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f8fb8541-ed09-5ad9-a731-f43375b1e224"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PlatformSupport-i686-linux-musl", artifacts_toml) for e in artifacts["PlatformSupport-i686-linux-musl"]]
...
if best_platform === nothing
    @debug("Unable to load PlatformSupport-i686-linux-musl; unsupported platform $(triplet(platform_key_abi()))")
else
    # Load the appropriate wrapper
    include(joinpath(@__DIR__, "wrappers", "$(best_platform).jl"))
end

end  # module PlatformSupport-i686-linux-musl_jll
